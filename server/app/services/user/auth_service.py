...
class AuthService:
    ...
    def save_new_user(self, email, password, name, dob, gender, address, phone_number):
        """Saves a new user to the database."""
        try:
            new_user = self.user_repository.create_new_user(email, password, name, dob, gender, address, phone_number)
            return new_user
